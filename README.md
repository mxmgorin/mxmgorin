...
- 👐 **Open-source** – contributor to PortMaster Games, where I ported several titles using **Lua** and **Bash**. Game porting** – contributor to the open-source project PortMaster Games, porting several titles using Lua and Bash.
